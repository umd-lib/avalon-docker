...
envsubst '$AVALON_DOMAIN,$AVALON_STREAMING_PORT,$AVALON_STREAMING_BASE_URL,$PROXY_CACHE_VALID_DURATION,$S3_PRESIGNED_URL_CACHE_DURATION' < /etc/nginx/nginx.conf.template > /etc/nginx/nginx.conf
