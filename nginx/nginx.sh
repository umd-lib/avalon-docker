...
[ -z "$DNS_RESOLVER_CONFIG" ] && DNS_RESOLVER_CONFIG="127.0.0.1"
...
export DNS_RESOLVER_CONFIG
envsubst '$AVALON_DOMAIN,$AVALON_STREAMING_PORT,$AVALON_STREAMING_BUCKET_URL,$VOD_MODE,$S3_SERVER,$S3_AUTH,$AVALON_STREAMING_BASE_URL,$PROXY_CACHE_VALID_DURATION,$S3_PRESIGNED_URL_CACHE_DURATION,$DNS_RESOLVER_CONFIG' < /etc/nginx/nginx.conf.template > /etc/nginx/nginx.conf
